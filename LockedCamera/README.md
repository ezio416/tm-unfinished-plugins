...
Keeps Cam 1/Cam 2 locked in place. Sort of works but is seizure-inducing. Most code is taken from [Camera Randomizer](https://openplanet.dev/plugin/camera-randomizer).
